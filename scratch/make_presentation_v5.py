"""
presentation_v5.pptx — FINAL VERSION
- Usa SOLO dati da:
    results/Train-eval-test-split (group-aware)/
    results/Test_Set_Benchmark/
...
# ─── Percorsi immagini (SOLO group-aware + Test_Set_Benchmark) ────────────────
...
# Benchmark
GPU_PLT  = f"{BENCH}/gpu_benchmark_plots.png"
CPU_PLT  = f"{BENCH}/cpu_benchmark_plots.png"
COMB_PLT = f"{BENCH}/combined_benchmark_plots.png"
...
sections = [
    ...
    ("6", "Confusion Matrix — Baseline vs T=20", "Visual error analysis per class"),
...
# ════════════════════════════════════════════════════════════════════════════
# SLIDE 11 — KD IMPACT PER CLASS (Delta chart)
# ════════════════════════════════════════════════════════════════════════════
sl = blank_slide(prs)
set_bg(sl, C_BG)
...
# ════════════════════════════════════════════════════════════════════════════
# SLIDE 12 — t-SNE LATENT SPACE (4565, T temperature comparison)
# ════════════════════════════════════════════════════════════════════════════
sl = blank_slide(prs)
set_bg(sl, C_BG)
...
# ════════════════════════════════════════════════════════════════════════════
# SLIDE 15 — CROSS-FRAME DISTILLATION INTRO
# ════════════════════════════════════════════════════════════════════════════
sl = blank_slide(prs)
set_bg(sl, C_BG)
...
# ════════════════════════════════════════════════════════════════════════════
# SLIDE 19 — SPEED-ACCURACY TRADE-OFF
# ════════════════════════════════════════════════════════════════════════════
sl = blank_slide(prs)
set_bg(sl, C_BG)
...
# SAVE
# ════════════════════════════════════════════════════════════════════════════
out = r"PRESENTAZIONE/presentation_v5.pptx"
prs.save(out)
print(f"Saved: {out}")
