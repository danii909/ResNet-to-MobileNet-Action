#!/bin/bash
# ============================================================================
# Single-job sweep: 3 conservative KD runs (all 24 frames) in one SLURM job.
#
# Usage:
#   sbatch cluster/submit_single_job_recovery24f_sweep.sh
# Optional:
#   TEACHER_CKPT=/path/to/teacher_finetune_best.pth sbatch cluster/submit_single_job_recovery24f_sweep.sh
# ============================================================================

#SBATCH --job-name=kd-rec24f-sweep
...
#SBATCH --output=logs/slurm-recovery-24f-sweep-%j.log
...
ROOT_DIR="$PROJECT_DIR/experiments/logs/slurm-recovery-24f-sweep-${SLURM_JOB_ID:-local}"
CHECKPOINT_ROOT="$PROJECT_DIR/experiments/checkpoints/slurm-recovery-24f-sweep-${SLURM_JOB_ID:-local}"
...

{
    ...
    echo "============================================================"
    echo "job_tag: slurm-recovery-24f-sweep-${SLURM_JOB_ID:-local}"
...
# A) Minimal aug baseline for 24f
run_one "kd_t10_a07_24f_minaug" "experiments/configs/distillation_t10_a07_24f_minaug.yaml"

# B) Light aug (conservative)
run_one "kd_t10_a07_24f_lightaug" "experiments/configs/distillation_t10_a07_24f_lightaug.yaml"

# C) Light aug + slightly higher LR
run_one "kd_t10_a07_24f_lightaug_lr6e4" "experiments/configs/distillation_t10_a07_24f_lightaug_lr6e4.yaml"
