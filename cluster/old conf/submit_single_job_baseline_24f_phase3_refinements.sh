#!/bin/bash
# ============================================================================
# Single-job sweep: 3 more baseline runs (24 frames)
# Phase 3: Baselines for warmup8, minaug, ls005 variants
#
# Usage:
#   sbatch cluster/submit_single_job_baseline_24f_phase3_refinements.sh
# ============================================================================

#SBATCH --job-name=baseline-24f-refine-p3
...
#SBATCH --output=logs/slurm-baseline-24f-phase3-%j.log
...
ROOT_DIR="$PROJECT_DIR/experiments/logs/slurm-baseline-24f-phase3-${SLURM_JOB_ID:-local}"
CHECKPOINT_ROOT="$PROJECT_DIR/experiments/checkpoints/slurm-baseline-24f-phase3-${SLURM_JOB_ID:-local}"
...

{
    ...
    echo "============================================================"
    echo "job_tag: slurm-baseline-24f-phase3-${SLURM_JOB_ID:-local}"
    echo "slurm_job_id: ${SLURM_JOB_ID:-}"
    echo "root_dir: $ROOT_DIR"
    echo "note: Phase 3 baseline training (other refinements: warmup8, minaug, ls005)"
    echo ""
} > "$SUMMARY_FILE"
...
run_one "baseline_warmup8_24f_lightaug" "experiments/configs/baseline_warmup8_24f_lightaug.yaml"
run_one "baseline_24f_minaug" "experiments/configs/baseline_24f_minaug.yaml"
run_one "baseline_ls005_24f_lightaug" "experiments/configs/baseline_ls005_24f_lightaug.yaml"

echo ""
echo "Baseline Phase 3 sweep completed in one SLURM job."
