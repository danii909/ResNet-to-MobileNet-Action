#!/bin/bash
# ============================================================================
# Single-job sweep: first 3 refinement KD runs (24 frames) in one SLURM job.
#
# Usage:
#   sbatch cluster/submit_single_job_24f_refine3_a.sh
# Optional:
#   TEACHER_CKPT=/path/to/teacher_finetune_best.pth sbatch cluster/submit_single_job_24f_refine6.sh
# ============================================================================

#SBATCH --job-name=kd-24f-refine3-a
...
#SBATCH --output=logs/slurm-24f-refine3-a-%j.log
...
ROOT_DIR="$PROJECT_DIR/experiments/logs/slurm-24f-refine3-a-${SLURM_JOB_ID:-local}"
CHECKPOINT_ROOT="$PROJECT_DIR/experiments/checkpoints/slurm-24f-refine3-a-${SLURM_JOB_ID:-local}"
...

{
    ...
    echo "============================================================"
    echo "job_tag: slurm-24f-refine3-a-${SLURM_JOB_ID:-local}"
